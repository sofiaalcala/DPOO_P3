...
public class Quiz extends Actividad{
	...
	public Quiz(String fechaLimite, String nivelDificultad, String duracionEsperada, boolean actividadCompletada, String idActividad, String tipoActividad, String idLP) {
	...
	public boolean crearActividad( Quiz quiz, LearningPath learningPath, String idLP, String idActividad) {
		this.todasActividades.add(quiz);
		...
		if (respuesta.contains(quiz) == true) {
			return true;
